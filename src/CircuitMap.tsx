...
interface Props {
  progress: number;       // 0~1 서킷 진행률
  colorStart: string;     // 섹터 시작 색
  colorEnd: string;       // 섹터 끝 색
  glowColor: string;      // 글로우 색
}

export default function CircuitMap({ progress, colorStart, colorEnd, glowColor }: Props) {
  return (
    <View style={s.wrap}>
      <Svg
        width="100%"
      ...
      >
        <Defs>
          <LinearGradient id="circuitGrad" x1="106" y1="90" x2="160" y2="4" gradientUnits="userSpaceOnUse">
